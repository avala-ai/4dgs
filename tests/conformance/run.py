...
LATE_FRONT_MATTER_FAMILIES: frozenset[str] = frozenset({"cpp", "dart", "python", "rust", "swift", "typescript"})
...
AGGREGATE_DECODED_BUDGET_FAMILIES: frozenset[str] = frozenset({"cpp", "dart", "python", "rust", "typescript"})
...
OPTIONAL_IDENTITY_DEFAULTS_FAMILIES: frozenset[str] = frozenset({"cpp", "dart", "python", "rust", "typescript"})
